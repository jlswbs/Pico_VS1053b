//  VS1053b PCM mode stereo 8bit 22050 Hz - Faust DSP Kick - 200Mhz overclock //
...
void loop1(){
  ...
  dsp->fHslider3 = random(44, 880); // frequency Hz
  dsp->fHslider2 = randomf(0.1f, 23.9f); // depth mod. 0..24
  dsp->fHslider6 = randomf(0.5f, 0.99f); // gain 0..1
