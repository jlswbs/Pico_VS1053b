// Vult DSP Ladder filter example //
...
void loop() {
  ...
  if (ReadReg(SCI_AICTRL0) > 32){
    ...
    for (int i = 0; i < 32; i++) {
      ...
      int16_t sample = Ladder_process(ladder, Saw_process(saw, cv), cvfilter, res) >> 2;
