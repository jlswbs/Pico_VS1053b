// YM2413 FM sound chip emulator - random melody + reverb //
...
void loop1(){
  ...
  uint8_t note = rand()%36;
  bool drumen = rand()%2;

  noteon(0,36+note,10,0);
  noteon(1,48+note,10,0);
  noteon(2,56+note,10,0);
  noteon(3,24+note,13,0);
  noteon(4,36+note,14,0);

  if(drumen) drum(0B11011);
