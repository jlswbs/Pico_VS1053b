// Vult DSP blit oscillator example //

#include "hardware/structs/rosc.h"
#include "PicoSPI.h"
#include "Blit.h"

Blit_process_type blit;
...
uint16_t pw = 0;    // pulse width
uint16_t wave = 0;  // wave type
...
void loop() {
  ...
  if (ReadReg(SCI_AICTRL0) > 32){
    ...
    for (int i = 0; i < 32; i++) {
      ...
      int16_t sample = Blit_process(blit, cv, pw, wave) >> 2;
