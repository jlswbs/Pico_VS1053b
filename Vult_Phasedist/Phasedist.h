...
typedef Phasedist__ctx_type_0 Phasedist_process_type;

void Phasedist__ctx_type_0_init(Phasedist__ctx_type_0 &_output_);

static_inline void Phasedist_process_init(Phasedist__ctx_type_0 &_output_){
...
public:
  ...
  int16_t output(int cv, int detune) { return Phasedist_process(data, cv, detune) >> 1; }
