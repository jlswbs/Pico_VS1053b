//  VS1053b PCM mode stereo 8bit 22050 Hz - Bubble water - 200Mhz overclock //
...
void loop(){
  ...
  uint8_t l = 255.0f * echo_verb(left + right, 0.6f);
  uint8_t r = 255.0f - l;
...
void loop1(){
  ...
  dsp->fHslider0 = 1000 + rand()%10000; // shape frequency Hz
  dsp->fHslider1 = randomf(0.39f, 0.99f); // gain 0..1
