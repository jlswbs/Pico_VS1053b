...
// platform definitions
  ...
  #define HV_UNIX 1
#elif defined(PICO_RP2040) || defined(ARDUINO_ARCH_RP2040) || defined(__arm__)
  #define HV_RP2040 1
...
#elif __cplusplus && !defined(HV_RP2040)
  #include <atomic>
...
#elif defined(HV_RP2040)
  // RP2040 nemá atomics → použij fallback
  #define hv_atomic_bool volatile bool
  #define HV_SPINLOCK_ACQUIRE(_x) while (_x) {} _x = true;
  #define HV_SPINLOCK_TRY(_x) if (!_x) { _x = true; return true; } else return false;
  #define HV_SPINLOCK_RELEASE(_x) (_x = false)
