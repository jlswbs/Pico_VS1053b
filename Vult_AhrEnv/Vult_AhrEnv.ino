...
void loop() {
  ...
  if (ReadReg(SCI_AICTRL0) > 32){
    ...
    for (int i = 0; i < 32; i++) {
      ...
      int16_t sample = Phasedist_process(phasedist, cv , Ahr_process(env, gate, attack, hold, release)) >> 2;
