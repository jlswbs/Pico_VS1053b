// VLSI 1053 codec PCM mixer - Amiga module player //
...
void loop(){
  ...
  hxcmod_fillbuffer(&mcontext,(msample*) &buff, 32, 0);  

  if (ReadReg(SCI_AICTRL0) > 32) for (int i = 0; i < 32; i++) WriteReg16(SCI_AICTRL1, buff[i]);
