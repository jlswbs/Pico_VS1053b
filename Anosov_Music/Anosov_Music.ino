// VS1053 MIDI - Anosov chaotic map music //

/*

  Based to Anosov chaotic map
...
void loop(){
  ...
  a = map(analogRead(A1), MINADC, MAXADC, 16999, 26999);
  a /= 10000.0f;
