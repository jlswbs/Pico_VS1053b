// VLSI 1053 codec PCM mixer - Classic multimode oscillator - (200Mhz overclock) //
...
void loop(){
  ...
  if (ReadReg(SCI_AICTRL0) > 32){
    ...
    for (int i = 0; i < 32; i++) {
      ...
      int16_t sample = 32767.0f * osc.Process();
