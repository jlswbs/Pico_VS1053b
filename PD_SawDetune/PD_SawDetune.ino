// VS1053b PCM mode stereo 8bit 44100 Hz - PureData detune saw oscillator //
// HVCC 0.14.0 atomic fix //
...
#define PITCH   0x8B2148DD
#define SHAPE   0xB063C1EC
#define DETUNE  0x764F1C36
...
void loop1(){
  ...
  pd_prog.sendFloatToReceiver(PITCH, random(50, 220)); // base frequency (pitch)
  pd_prog.sendFloatToReceiver(SHAPE, 0.1f);   // frequency shape 0-1
  pd_prog.sendFloatToReceiver(DETUNE, 0.6f);  // detune depth 0-1
