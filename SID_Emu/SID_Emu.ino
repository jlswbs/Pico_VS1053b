// VLSI 1053 codec PCM mixer - SID chip emulator example //
...
void loop1(){
  ...
  while(1) {
    ...
    uint16_t n1 = regproc() * 4;
    set_frequency(n1 * 17, CHANNEL1);
    uint16_t n2 = regproc() * 2;
    set_frequency(n2 * 17, CHANNEL2);
    uint16_t n3 = regproc() * 16;
    set_frequency(n3 * 17, CHANNEL2);
